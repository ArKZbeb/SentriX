...
public class EnigmaClass {
    ...
    // Méthode statique pour chiffrer un message avec l'interface console
        ...
        Boolean cleSecrete = false;
        System.out.print("Entré votre clé : ");
        ...
        if (configKey.equals("HistorII")) {
            ...
            System.out.print("Geben Sie einen Entschlüsselungsschlüssel ein (identisch mit dem, der zum Verschlüsseln verwendet wurde) : ");
        ...
        if(cleSecrete)
        {
            ...
            System.out.print("Geben Sie die Nachricht ein, die mit Enigma verschlüsselt werden soll : ");
            String message = scanner.nextLine();
            System.out.println("Mit Enigma verschlüsselte Nachricht : " + enigma.chiffrer(message));
            System.out.println("********************########################################################*#####################**\n" +
                    "*#####**###*#####################################################################################***\n" +
                    "#####################################*=::::::---=++*######################*##################*******\n" +
                    "##################################*+---::::---====+**#%%#################**#*#########**************\n" +
